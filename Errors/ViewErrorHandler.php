...
use App\Errors\ViewErrorRenderer;
...
class ViewErrorHandler implements ErrorHandlerInterface
{
    protected $htmlErrorRenderer = ViewErrorRenderer::class;
    ...
    protected function respond(): ResponseInterface
    {
        ...
        return $view->render($response, 'errors.twig', ['error' =>  $data]);
    }
